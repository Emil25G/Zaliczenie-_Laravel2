...
class Uri implements UriInterface, \JsonSerializable
{
    ...
    private function applyParts(array $parts): void
    {
        $this->scheme = isset($parts['scheme'])
            ...
            : '';
        $this->userInfo = isset($parts['users'])
            ? $this->filterUserInfoComponent($parts['users'])
            : '';
     ...
     *
     * @throws \InvalidArgumentException If the users info is invalid.
     */
