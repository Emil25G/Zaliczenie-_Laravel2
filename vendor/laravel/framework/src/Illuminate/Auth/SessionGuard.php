...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function attemptWhen(array $credentials = [], $callbacks = null, $remember = false)
    {
        ...
        // the users is retrieved and validated. If one of the callbacks returns falsy we do
        // not login the users. Instead, we will fail the specific authentication attempt.
    ...
    /**
     * Determine if the users should login by executing the given callbacks.
     *
     * @param  array|callable|null  $callbacks
    ...
    /**
     * Rehash the users's password if enabled and required.
     *
     * @param  \Illuminate\Contracts\Auth\Authenticatable  $user
     * @param  array  $credentials
     * @return void
    ...
    /**
     * Rehash the current users's password for logging out other devices via AuthenticateSession.
     *
     * @param  string  $password
     * @return \Illuminate\Contracts\Auth\Authenticatable|null
     *
