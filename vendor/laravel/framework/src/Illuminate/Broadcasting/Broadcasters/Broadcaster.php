...
{
    /**
     * The callback to resolve the authenticated users information.
     *
     * @var \Closure|null
     */
    ...
    /**
     * Resolve the authenticated users payload for the incoming connection request.
     *
    ...
    /**
     * Register the users retrieval callback used to authenticate connections.
     *
     * See: https://pusher.com/docs/channels/library_auth_reference/auth-signatures/#user-authentication.
     *
    ...
    /**
     * Retrieve the authenticated users using the configured guard (if any).
     *
     * @param  \Illuminate\Http\Request  $request
     * @param  string  $channel
     * @return mixed
