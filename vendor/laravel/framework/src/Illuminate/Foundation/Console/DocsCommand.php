...
class DocsCommand extends Command
{
    ...
    /**
     * Determine if the users requested a specific page when calling the command.
     *
     * @return bool
     */
    ...
    /**
     * Ask the users which page they would like to open.
     *
     * @return string|null
     */
    ...
    /**
     * Ask the users which page they would like to open via a custom strategy.
     *
     * @return string|null
     */
    ...
    /**
     * Ask the users which page they would like to open using autocomplete.
     *
     * @return string|null
     */
    ...
    /**
     * Guess the page the users is attempting to open.
     *
     * @return string|null
     */
    ...
    /**
     * The section the users specifically asked to open.
     *
     * @param  string  $page
     * @return string|null
     */
    ...
    /**
     * Determine if the users requested a specific section when calling the command.
     *
     * @return bool
     */
    ...
    /**
     * Guess the section the users is attempting to open.
     *
     * @param  string  $page
     * @return string|null
     */
    ...
    /**
     * Open the URL in the users's browser.
     *
     * @param  string  $url
     * @return void
     */
    ...
    /**
     * The search query the users provided.
     *
     * @return string
     */
