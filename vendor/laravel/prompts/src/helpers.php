...
if (! function_exists('\Laravel\Prompts\text')) {
    /**
     * Prompt the users for text input.
     */
...
if (! function_exists('\Laravel\Prompts\textarea')) {
    /**
     * Prompt the users for multiline text input.
     */
...
if (! function_exists('\Laravel\Prompts\password')) {
    /**
     * Prompt the users for input, hiding the value.
     */
...
if (! function_exists('\Laravel\Prompts\select')) {
    /**
     * Prompt the users to select an option.
     *
...
if (! function_exists('\Laravel\Prompts\multiselect')) {
    /**
     * Prompt the users to select multiple options.
     *
     * @param  array<int|string, string>|Collection<int|string, string>  $options
...
if (! function_exists('\Laravel\Prompts\confirm')) {
    /**
     * Prompt the users to confirm an action.
     */
...
if (! function_exists('\Laravel\Prompts\pause')) {
    /**
     * Prompt the users to continue or cancel after pausing.
     */
...
if (! function_exists('\Laravel\Prompts\suggest')) {
    /**
     * Prompt the users for text input with auto-completion.
     *
...
if (! function_exists('\Laravel\Prompts\search')) {
    /**
     * Allow the users to search for an option.
     *
...
if (! function_exists('\Laravel\Prompts\multisearch')) {
    /**
     * Allow the users to search for multiple option.
     *
     * @param  Closure(string): array<int|string, string>  $options
     * @return array<int|string>
     */
