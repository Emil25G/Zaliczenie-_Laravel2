...
class CronExpression
{
    ...
    /**
     * Registered a users defined CRON Expression Alias.
     *
    ...
    /**
     * Unregistered a users defined CRON Expression Alias.
     *
     * @throws LogicException If the users tries to unregister a built-in alias
     */
