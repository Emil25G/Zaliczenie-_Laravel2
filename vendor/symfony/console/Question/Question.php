...
class Question
{
     ...
     * @param string|bool|int|float|null $default  The default answer to return if the users enters nothing
     */
    ...
    /**
     * Returns whether the users response accepts newline characters.
     */
    ...
    /**
     * Sets whether the users response should accept newline characters.
     *
     * @return $this
     */
     ...
     *
     * The callback is passed the users input as argument and should return an iterable of corresponding suggestions.
     *
     * @return $this
     */
